...
--     WHERE Items.Id = Sellings.ItemId
--     GROUP BY ItemId) as cnt 
-- FROM Items 
...
-- GO
-- CREATE PROCEDURE GetCheapestAtVal @val DECIMAL
-- AS
-- SELECT Items.Name, (SELECT COUNT(*) FROM Items WHERE Items.Price < @val ) as cnt
-- FROM Items
-- GROUP BY Items.Name;
